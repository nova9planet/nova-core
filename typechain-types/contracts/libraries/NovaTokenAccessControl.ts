...
export interface NovaTokenAccessControlInterface extends utils.Interface {
  functions: {
...
export interface NovaTokenAccessControl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NovaTokenAccessControlInterface;
